...
func (x *AddressToken) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddressToken) ProtoMessage() {}

func (x *AddressToken) ProtoReflect() protoreflect.Message {
	mi := &file_address_token_proto_msgTypes[0]
...
// Deprecated: Use AddressToken.ProtoReflect.Descriptor instead.
func (*AddressToken) Descriptor() ([]byte, []int) {
	return file_address_token_proto_rawDescGZIP(), []int{0}
}

func (x *AddressToken) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *AddressToken) GetTokenContractAddress() string {
	if x != nil {
...
var file_address_token_proto_rawDesc = []byte{
	...
	,
...
var file_address_token_proto_goTypes = []interface{}{
	(*AddressToken)(nil), // 0: models.AddressToken
}
